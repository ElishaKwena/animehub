        ...
        <>
            <main className="relative w-full min-h-screen dark:bg-black">
                ...
                <div className="contents-container w-full lg:w-[98%] mx-auto flex flex-col gap-3 p-2">
                    ...
                    <section className="flex items-center flex-col gap-2 w-full mx-auto mt-10 lg:min-h-[100vh]">
                    ...
                    <section className="flex flex-col gap-3 w-full mx-auto lg:mt-10 lg:min-h-[100vh]">
                    ...
                    <section className="pricing w-full mx-auto flex flex-col mt-10 gap-3 lg:min-h-[100vh]">
                    ...
                    <section className="testimonies w-full mx-auto mt-10 font-fira-code font-extrabold lg:min-h-[100vh] md:mt-28">
                    ...
                    <section className="mt-24 w-full mx-auto flex-col flex gap-2 lg:min-h-[100vh">
                        <Competitors/>
