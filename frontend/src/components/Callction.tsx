    ...
    return(
       ...
       <div className="relative overflow-hidden bg-gradient-to-r from-neon_purple/80 to-fashion_pink/50 lg:py-16 py-8 lg:px-8 rounded-2xl shadow-2xl border-t-4 border-pink-500">              
            <div className="relative z-10 mx-auto text-center px-1">
                ...
                <Link to={ROUTE_PATHS.home} className="relative px-12 py-4 bg-gradient-to-r from-yellow-400 to-orange-500 text-black font-bold rounded-full text-lg shadow-lg hover:shadow-yellow-400/40 transition-all hover:scale-105 group">
